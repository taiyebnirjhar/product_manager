  ...
  return (
    <div className="absolute flex flex-col justify-center items-center w-[90%] h-[90%] z-[100]">
      ...
      >
        ...
        <div className="text-[80px] font-bold m-[1%] ">🫠</div>
        <div className="text-[15px] w-1/2 min-w-[40%] text-center text-black m-[1%]">
          It looks like something went wrong. This feature might be temporarily
          unavailable. Please try again or return to the previous page.
        </div>
        <div className="flex gap-6 mt-8">
          <Button
            onClick={() => router.back()}
            variant={"outline"}
            className=" border-2 border-border transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105"
          >
            <svg
